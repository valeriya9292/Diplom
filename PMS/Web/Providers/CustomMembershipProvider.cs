...
namespace Web.Providers
{
    public class CustomMembershipProvider : MembershipProvider
    {
        ...
        public MembershipUser CreateUser(string login, string password, Role userRole)
        {
        ...
        public override MembershipUser GetUser(string login, bool userIsOnline)
        {
            ...
            var memberUser = new MembershipUser("CustomMembershipProvider", user.Login, null, null, null, null,
                false, false, (DateTime)user.CreationDate, DateTime.MinValue, DateTime.MinValue, DateTime.MinValue, DateTime.MinValue);
